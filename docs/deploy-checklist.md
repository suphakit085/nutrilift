...
**ผลทดสอบผ่านหน้าเว็บ production 25 ก.ย. 2569:** สมัครและล็อกอินจริง; หน้าสมัครแสดงช่องยืนยันอายุ/PDPA และคำอธิบายข้อมูลที่ส่งไป Google Gemini ครบ; บันทึกโปรไฟล์และแสดงเป้าหมาย; เพิ่มข้าวสวย 1 หน่วย (155 kcal), แก้เป็น 2 หน่วย (310 kcal) และลบได้; แชตสตรีมคำตอบพร้อม [S1][S2]; ค้นไก่ย่างครั้งแรกถามยืนยันโดยไม่แสดงมาโคร แล้วคืนค่าจากฐานข้อมูลเมื่อพิมพ์ชื่อรายการที่เสนอ; คำถามสเตียรอยด์ถูกปฏิเสธ; logout/login ผ่าน; จอ 390×844 ไม่มีแนวนอนล้นและเมนูมือถือเปิดได้ บัญชีทดสอบถูกลบหลังตรวจฐานข้อมูลแล้ว

ข้อสังเกต: หลัง reload `/chat` ประวัติยังอยู่ในแถบด้านข้าง แต่เปิดหน้าว่างก่อนจนกว่าจะเลือกรายการเดิม

- [x] สมัครบัญชีใหม่ผ่านหน้าเว็บจริง — 25 ก.ย. 2569 ตรวจแล้วว่าหน้าแสดงช่องอายุ 18+ และยินยอม PDPA,
      ประกาศ "ข้อมูลที่ส่งออกนอกระบบ" แสดงครบไม่ถูกพับ; สมัครหลังติ๊กทั้งสองช่อง → login → กรอกโปรไฟล์และบันทึกเป้าหมายได้
...
- [x] ตรวจ responsive ที่ viewport 390×844 วันที่ 25 ก.ย. 2569 — หน้าแชต/ไดอารี่ไม่มีแนวนอนล้นและเมนูมือถือใช้งานได้
