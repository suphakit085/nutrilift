...
**ชื่อโครงงาน:** การพัฒนาแชตบอทให้คำแนะนำด้านโภชนาการเฉพาะบุคคลสำหรับผู้ฝึกเวทเทรนนิ่ง
ด้วยเทคนิคการสร้างคำตอบเสริมด้วยการค้นคืน (RAG)
*Development of a Personalized Nutrition Chatbot for Resistance Training Using Retrieval-Augmented Generation*
...
ตอนนี้มีการ์ดความรู้ **26 ใบ** และ `foods.csv` **382/383 แถว**เป็นค่าจริงที่มีรหัสอ้างอิง
...
(ปัจจุบัน `2026-09-11`) ไม่งั้นคนที่ยินยอมไปแล้วจะถูกนับว่ายอมรับข้อความที่ไม่เคยเห็น
