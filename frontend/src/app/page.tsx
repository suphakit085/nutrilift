 ...
 *   - knowledge/cards/*.md (26 files, excl. _TEMPLATE.md) and knowledge/foods.csv (378 rows)
...
const STATS = [
  ...
  { value: "377", label: "เมนูอาหารที่ระบุแหล่งที่มาได้" },
        ...
        <section id="food" className="mt-20 bg-surface-sunken py-16 sm:mt-24 sm:py-20">
          <div className={`${SHELL} grid gap-10 lg:grid-cols-12 lg:items-start lg:gap-10`}>
            <div className="min-w-0 lg:col-span-4">
              ...
              {/* Not "ตามรอยกลับได้": 1 of the 378 rows is a TOVERIFY-LABEL
              ...
              <p className="mt-5 text-[15px] leading-[1.8] text-body">
                ตารางอาหารมี 378 แถว ในนั้น 377 แถวมาจากฐานข้อมูลองค์ประกอบอาหารที่เผยแพร่จริง
